...
case class BattleScene(controller: ControllerInterface) extends BaseScene {
...
//____Upper Segment___________
  ...
  root = new StackPane { children = List(backgroundImage, bottomBar, middleBar, upperBar, backButton, dataBar) }
